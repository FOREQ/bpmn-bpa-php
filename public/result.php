            ...
            content.innerHTML = `
                ...
                <div class="rp-section">
                    ...
                    <div class="rp-grid">
                        ...
                        ${metric('Расчёт сложности', escapeHtml(practical.scores.metricsScore ?? 'Еще не оценено'))}
                ...
                <div class="rp-section">
                    ...
                    <div class="rp-grid">
                        ${metric('Баллы за теоретический тест', escapeHtml(testPoints + ' из 20'), 'emphasis')}
                        ${metric('Баллы за практическое задание', practical.isGraded ? escapeHtml(practicalPoints + ' из 30') : 'После проверки практики', 'emphasis')}
                        ${metric('Общий результат', practical.isGraded ? escapeHtml(overallTotal + ' из 50') : 'После проверки практики', 'emphasis')}
                        ${metric('Итог', escapeHtml(finalLabel), 'emphasis accent')}
                    </div>
                </div>
